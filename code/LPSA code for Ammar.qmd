...
### 5. Texture for grouped IDs (This is your average texture based on your replicates)
...
### 6. Texture Differences in Failures ( If two failed samples have the same texture, I did not rerun them, but you may want to depending on your study)
...
### 7. Particle Size Classifications (not working but feel free to modify)
